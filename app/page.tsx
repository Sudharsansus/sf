    ...
    <div style={{ background: c.bg, minHeight: '100vh', color: c.text, fontFamily: "'Inter', -apple-system, sans-serif", transition: 'background .3s, color .3s' }}>
          ...
          {(g.step === 'idle' || g.step === 'failed') && (
            <div style={{ marginTop: 10, display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="/upload?tab=script"
                style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, fontWeight: 500, color: '#c4b5fd', background: 'transparent', border: '1.5px solid rgba(139,92,246,0.6)', padding: '10px 20px', borderRadius: 10, backdropFilter: 'blur(10px)', transition: 'all .2s', textDecoration: 'none', boxShadow: '0 0 12px rgba(139,92,246,0.5)' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(139,92,246,1)'; e.currentTarget.style.boxShadow = '0 0 22px rgba(139,92,246,0.8)'; e.currentTarget.style.color = '#ddd6fe' }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(139,92,246,0.6)'; e.currentTarget.style.boxShadow = '0 0 12px rgba(139,92,246,0.5)'; e.currentTarget.style.color = '#c4b5fd' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="/upload?tab=audio"
                style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, fontWeight: 500, color: '#fdba74', background: 'transparent', border: '1.5px solid rgba(249,115,22,0.6)', padding: '10px 20px', borderRadius: 10, backdropFilter: 'blur(10px)', transition: 'all .2s', textDecoration: 'none', boxShadow: '0 0 12px rgba(249,115,22,0.5)' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(249,115,22,1)'; e.currentTarget.style.boxShadow = '0 0 22px rgba(249,115,22,0.8)'; e.currentTarget.style.color = '#fed7aa' }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(249,115,22,0.6)'; e.currentTarget.style.boxShadow = '0 0 12px rgba(249,115,22,0.5)'; e.currentTarget.style.color = '#fdba74' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="/upload"
                style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, fontWeight: 500, color: '#f9a8d4', background: 'transparent', border: '1.5px solid rgba(236,72,153,0.6)', padding: '10px 20px', borderRadius: 10, backdropFilter: 'blur(10px)', transition: 'all .2s', textDecoration: 'none', boxShadow: '0 0 12px rgba(236,72,153,0.5)' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(236,72,153,1)'; e.currentTarget.style.boxShadow = '0 0 22px rgba(236,72,153,0.8)'; e.currentTarget.style.color = '#fbcfe8' }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(236,72,153,0.6)'; e.currentTarget.style.boxShadow = '0 0 12px rgba(236,72,153,0.5)'; e.currentTarget.style.color = '#f9a8d4' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 20h9"/>
      ...
      <footer className="footer-inner" style={{ borderTop: `1px solid ${c.border}`, padding: '18px 24px', maxWidth: 1080, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <span style={{ fontSize: 11, color: dark ? '#aaa' : c.muted }}>© 2026 SUS</span>
        </div>
      </footer>

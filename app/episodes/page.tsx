      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '88px 24px' }}>
        ...
        {!loading && episodes.length === 0 && (
          <div style={{ border: `1px solid ${c.border}`, borderRadius: 12, padding: '80px 24px', textAlign: 'center' }}>
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 16, color: c.subtle }}>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.3 }}><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="8" y1="22" x2="16" y2="22"/></svg>
            </div>
            ...
            {episodes.map((ep: any, i: number) => (
              <div key={ep.id} className="ep-row" style={{ padding: '14px 24px', display: 'flex', alignItems: 'center', gap: 14, background: 'transparent' }}>
                {ep.thumbnailUrls?.[0] ? (
                  ...
                  <div style={{ width: 44, height: 44, borderRadius: 8, background: c.surface2, border: `1px solid ${c.border}`, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', color: c.subtle }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.4 }}><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/></svg>
                  </div>
                )}
                <div style={{ flex: 1 }}>
